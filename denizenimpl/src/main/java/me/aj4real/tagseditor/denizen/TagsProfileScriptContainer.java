    ...
    public TagsProfileScriptContainer(YamlConfiguration configurationSection, String scriptContainerName) {
        ...
        TagsSerializer serializer = TagsSerializer.read(
                org.bukkit.configuration.file.YamlConfiguration.loadConfiguration(
                        new StringReader(configurationSection.saveToString(true))), new TagsSerializer.Context(TagsProfileScriptContainer.class, scriptContainerName, (s) -> Debug.echoError(s)));
