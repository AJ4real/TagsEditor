...
package me.aj4real.tagseditor.nms.v1_18_1;
...
public class NMSImpl implements NMS {
    ...
    private static Registry<net.minecraft.world.level.biome.Biome> biomes;
    ...
    public Object getDefaultPacket() {
        return new ClientboundUpdateTagsPacket(((CraftServer) Bukkit.getServer())
                .getHandle().getServer().getTags().serializeToNetwork(((CraftServer) Bukkit.getServer())
                        .getHandle().getServer().registryAccess()));
    }
